       	...
       	<div class="row">
			<div class="col-sm-12">
				<div class="card-box">
					...
					{!! Form::model($usr, ['method' => 'PATCH','class' => 'form-horizontal', 'files'=>true, 'route' => ['user.update', $usr->user_id]]) !!}
					    ...
					    <div class="form-group">
					        ...
					        <div class="col-md-10">
					        	...
					        	<small class="label label-danger">Leave this blank if password not to be changed</small>
					        </div>
					    </div>
					    ...
					    <div class="form-group">
					        ...
					        <div class="col-md-10">
					        	{{ Form::select('role_id', $role, $usr->role_id, array('class' => 'form-control')) }}
					        </div>
					    </div>
					    ...
					    @if(\Auth::user()->role_id==1)
						    <div class="form-group">
						        ...
						        <div class="col-md-10">
						        	{{ Form::select('status', [0 => 'Tidak Aktif', 1 => 'Aktif'], $usr->status, array('class' => 'form-control')) }}
						        </div>
						    </div>
					    @endif
