       	...
       	<div class="row">
			<div class="col-sm-12">
				<div class="card-box">
					...
					{!! Form::model($product, ['method' => 'PATCH','class' => 'form-horizontal', 'autocomplete' => 'off', 'files'=>true, 'route' => ['product.update', $product->product_id]]) !!}
			        	...
			        	<div class="form-group">
                            ...
                            <div class="col-md-10">
                                {{ Form::select('sub_category_id', $sub_category, Input::old('sub_category_id'), array('class' => 'form-control', 'id' => 'sub_category_id')) }}
                            </div>
                        </div>
			        	...
			        	<div class="form-group">
                            ...
                            <div class="col-md-10">
                                {{ Form::select('printer_id', $printer, Input::old('printer_id'), array('class' => 'form-control', 'id' => 'printer_id')) }}
                            </div>
                        </div>
					    ...
					    @if ($product->image)
						    <div class="form-group">
						    	<div class="col-sm-offset-2 col-sm-10">
						        	{{ HTML::image($product->thumbnail('large'), null, array('width'=>'300px', 'class' => 'img-thumbnail')) }}
						        </div>
						    </div>
					    @endif
